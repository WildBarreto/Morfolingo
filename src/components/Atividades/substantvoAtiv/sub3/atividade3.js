...
function Atividades({ width, percent }) {
  ...
  function verificar() {
    const test = nome;
    if (test === "enfermeira" || test === "Enfermeira") {
      // alert("Parabems você acertou: ");
      return "/Atividade3/AcertouSub3";
    } else {
      //alert("tente novamente: ");
      return "/Atividade3/ErrouSub3";
    }
  }
  ...
  return (
    <Container>
      ...
      <section id="content">
        <h2>Digite o substantivo comum da frase abaixo:</h2>

        <img id="medico" src={Enfermeira} alt="estrelas" />

        <label>Olá me chamo Marta, eu sou enfermeira!</label>
